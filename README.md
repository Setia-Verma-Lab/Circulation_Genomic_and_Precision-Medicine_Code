...
### 2. Phewas code: 
Phewas was run on the FOG2 variant `chr8:105802051:A:G` for participants of the Penn Medicine Biobank using the R PheWAS package.
https://github.com/Setia-Verma-Lab/Circulation_Genomic_and_Precision-Medicine_Code/blob/main/phewas.R
### 3. Manhattan plot code: 
Manhattan plot was made for the PheWAS results using `ggplot2` in R. 
